...
function OgpCard({ placement, index }: { placement: OgpCardPlacement; index: number }) {
...
export function OgpCardLayer({ news, projection }: OgpCardLayerProps) {
  const placements = useMemo(
    () => computeOgpCardPlacements(news, projection),
    [news, projection],
  );
